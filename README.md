...
| Dir | Contents |
|-----|----------|
| `kicad/` | 12 KiCad projects, deliberately spanning **flat → deep hierarchy**, simple → complex, with **buses / global & hierarchical labels / power symbols** — chosen to exercise a KiCad parser. |
